...
export const FIXTURE_PROJECTS: Project[] = [
  {
    ...
    description: 'ออกแบบและพัฒนาเว็บใหม่', kanbanColumns: ['To Do', 'In Progress', 'Review', 'Done'], departments: ['Digital', 'Billboard', 'Store'], kind: 'main', archived: false,
  ...
  },
  {
    ...
    description: 'แคมเปญโฆษณาไตรมาส 3', kanbanColumns: ['To Do', 'In Progress', 'Review', 'Done'], departments: ['Airport', '7-Eleven', 'BUS', 'Static'], kind: 'main', archived: false,
  ...
  },
  {
    ...
    description: 'พัฒนา CRM สำหรับทีมขาย', kanbanColumns: ['To Do', 'In Progress', 'Review', 'Done'], departments: ['OI', 'Construction'], kind: 'main', archived: false,

  ...
  return (
    <main className="w-full px-4 py-6 sm:px-6 lg:px-8">
      <Reveal y={10}>
        <Link
          href="/"
          className="btn-press inline-flex items-center gap-1.5 rounded-full bg-white/70 px-3 py-1 text-xs font-medium text-indigo-600 shadow-sm ring-1 ring-indigo-100 backdrop-blur transition hover:bg-indigo-50 hover:ring-indigo-200"
        >
          ← กลับ Dashboard
        </Link>
      </Reveal>
      <Reveal delay={0.06}>
        <header className="hero-card mb-4 mt-3 flex flex-col gap-3 rounded-2xl p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
          <div>
            ...
            <div className="mt-1.5 flex items-center gap-2">
              <div className="h-2 w-40 overflow-hidden rounded-full bg-slate-900/10">
                <div
                  className="bar-stripes h-full rounded-full bg-gradient-to-r from-indigo-500 via-blue-500 to-sky-400 transition-[width] duration-700 ease-out"

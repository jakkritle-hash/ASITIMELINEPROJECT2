...
export async function NavBar() {
  ...
  return (
    <nav className="nav-hairline sticky top-0 z-30 border-b border-slate-900/[0.07] bg-white/70 shadow-[0_1px_0_rgba(15,23,42,0.04),0_8px_24px_-16px_rgba(15,23,42,0.15)] backdrop-blur-xl">
      <div className="flex flex-wrap items-center gap-x-2 gap-y-2 px-4 py-2.5 sm:flex-nowrap sm:px-6 lg:px-8">
        ...
        <Link href="/" className="group order-1 mr-2 flex shrink-0 items-center gap-2.5 sm:mr-5">
          <span className="logo-glow flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-blue-600 text-white ring-1 ring-inset ring-white/25 transition-transform duration-300 group-hover:-rotate-6 group-hover:scale-110">

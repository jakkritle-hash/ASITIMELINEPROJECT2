  ...
  return (
    <>
      <button
        ...
        className="btn-shine btn-press inline-flex items-center gap-1.5 rounded-lg bg-blue-600 px-3.5 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-blue-700 hover:shadow-md hover:shadow-blue-500/25"
      >
        <span className="text-base leading-none">+</span> New Tasks
      </button>

      {/* ใช้ Modal ร่วม (portal ไป body) — modal จึงไม่ถูกกักหลัง Kanban แม้ header อยู่ใน Reveal/transform */}
      <Modal open={open} onClose={() => setOpen(false)}>
        ...
        <div className="mt-5 flex justify-end gap-2">
          ...
          <button onClick={submit} disabled={pending} className="btn-press rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-blue-700 hover:shadow-md hover:shadow-blue-500/25 disabled:opacity-50">
